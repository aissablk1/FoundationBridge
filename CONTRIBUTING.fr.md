...
> Les modules `FoundationBridgeCore` et `ProtocolConversion` compilent et se testent
...
« Un cœur, plusieurs façades » — voir `docs/specs/2026-06-04-foundationbridge-v2-design.md`.
...
- Adaptateurs de protocole (MCP, REST, ACP, WebSocket).
